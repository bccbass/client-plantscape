...
const AreaListTest = ({areas, plants}) => {
        ...
        // add link to the NewArea component here
            ...
            <> 
                <Dropdown data-bs-theme="light">
                    <Dropdown.Toggle id="dropdown-button-dark-example1" variant="secondary" style={{ backgroundColor: "#53835C"}}>
                        Select an Area
                    </ Dropdown.Toggle>
                    ...
                    <Dropdown.Menu>
                        {areas.map((area) => {
                            return (
                      <Dropdown.Item style={{ backgroundColor: "#A2FFB3", color: "#426949"}} onClick={(e) => {
                        e.preventDefault();
                        setAreaSelect(area);
                      }}>
                        {area.name}
